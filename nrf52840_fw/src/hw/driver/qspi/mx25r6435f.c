...
bool init(void)
{
  ...
  config.pins.csn_pin = NRF_GPIO_PIN_MAP(0,17);
  config.pins.io0_pin = NRF_GPIO_PIN_MAP(0,20);
  config.pins.io1_pin = NRF_GPIO_PIN_MAP(0,21);
  config.pins.io2_pin = NRF_GPIO_PIN_MAP(0,22);
  config.pins.io3_pin = NRF_GPIO_PIN_MAP(0,23);
