...
{
  {NRF_GPIO_PIN_MAP(0,11), _DEF_LOW, _DEF_HIGH},
  {NRF_GPIO_PIN_MAP(0,12), _DEF_LOW, _DEF_HIGH},
  {NRF_GPIO_PIN_MAP(0,24), _DEF_LOW, _DEF_HIGH},
  {NRF_GPIO_PIN_MAP(0,25), _DEF_LOW, _DEF_HIGH},
};
